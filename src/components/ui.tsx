    ...
    <div className="divide-y divide-hairline border-y border-hairline">
      {faqs.map((f) => (
        <details key={f.q} className="group py-5">
          <summary className="flex min-h-11 cursor-pointer list-none items-start justify-between gap-4 py-1">
      ...
      {background && (
        <>
          ...
          <div
            ...
            className={
              artwork
                ? "absolute inset-0 bg-gradient-to-l from-white/28 via-white/72 to-white/92 lg:hidden"
                : lightPhoto
              ...
              {breadcrumbs.map((b, i) => (
                <li key={b.path} className="flex items-center gap-2">
                  ...
                  {i === breadcrumbs.length - 1 ? (
                    ...
                    <Link href={b.path} className="inline-block py-2.5 hover:text-sbd-red">
                      {b.name}
                    </Link>
                  )}
                </li>
